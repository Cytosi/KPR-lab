...
# skip-gram训练模型
# model = word2vec.Word2Vec.load('./ckpt/0325.model')
...
if __name__ == "__main__":
    ...
    print("\n"*3)
    print("--------------------------------")
    sim1 = model.wv.similarity('岳不群', '林平之')
    sim2 = model.wv.similarity('岳不群', '岳灵珊')
    print(f'sim(岳不群, 林平之) = {sim1:.4f}')
    print(f'sim(岳不群, 岳灵珊) = {sim2:.4f}')
    print("\n"*3)
